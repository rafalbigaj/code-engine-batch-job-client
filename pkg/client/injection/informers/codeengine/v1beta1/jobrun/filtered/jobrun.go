...
func withInformer(ctx context.Context) (context.Context, []controller.Informer) {
	...
	for _, selector := range labelSelectors {
		...
		inf := f.Codeengine().V1beta1().JobRuns()
...
func Get(ctx context.Context, selector string) v1beta1.JobRunInformer {
...
var _ v1beta1.JobRunInformer = (*wrapper)(nil)
var _ codeenginev1beta1.JobRunLister = (*wrapper)(nil)

func (w *wrapper) Informer() cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(nil, &apiscodeenginev1beta1.JobRun{}, 0, nil)
}

func (w *wrapper) Lister() codeenginev1beta1.JobRunLister {
	return w
}

func (w *wrapper) JobRuns(namespace string) codeenginev1beta1.JobRunNamespaceLister {
	return &wrapper{client: w.client, namespace: namespace, selector: w.selector}
}

func (w *wrapper) List(selector labels.Selector) (ret []*apiscodeenginev1beta1.JobRun, err error) {
	reqs, err := labels.ParseToRequirements(w.selector)
	if err != nil {
		return nil, err
	}
	selector = selector.Add(reqs...)
	lo, err := w.client.CodeengineV1beta1().JobRuns(w.namespace).List(context.TODO(), v1.ListOptions{
...
func (w *wrapper) Get(name string) (*apiscodeenginev1beta1.JobRun, error) {
	// TODO(mattmoor): Check that the fetched object matches the selector.
	return w.client.CodeengineV1beta1().JobRuns(w.namespace).Get(context.TODO(), name, v1.GetOptions{
		// TODO(mattmoor): Incorporate resourceVersion bounds based on staleness criteria.
	})
}
